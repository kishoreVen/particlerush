...
class SLevelGeneratorModeControls : public SCompoundWidget, public FNotifyHook
{
public:
	SLATE_BEGIN_ARGS(SLevelGeneratorModeControls) {}
	SLATE_END_ARGS()
 ...
 */
class FPrototypeLevelGeneratorToolKit : public FModeToolkit
{
public:
...
private:
	...
	TSharedPtr<class SLevelGeneratorModeControls> LevelGeneratorWidget;
};
